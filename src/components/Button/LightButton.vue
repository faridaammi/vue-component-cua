...
const colors = ref({
  light: "text-dark bg-light border hover:bg-light hover:opacity-70 disabled:cursor-not-allowed focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center  items-center dark:bg-transparent dark:border-gray-600 dark:text-light dark:hover:bg-transparent dark:focus:ring-light shadow-sm",
  primary: "text-primary bg-light border hover:bg-light hover:opacity-70 disabled:cursor-not-allowed focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center  items-center dark:bg-transparent dark:border-gray-600 dark:text-primary dark:hover:bg-transparent dark:focus:ring-light shadow-sm",
  success: "text-success bg-light border hover:bg-light hover:opacity-70 disabled:cursor-not-allowed focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center  items-center dark:bg-transparent dark:border-gray-600 dark:text-success dark:hover:bg-transparent dark:focus:ring-light shadow-sm",
  dark: "text-dark bg-light border hover:bg-light hover:opacity-70 disabled:cursor-not-allowed focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center  items-center dark:bg-transparent dark:border-gray-600 dark:text-dark dark:hover:bg-transparent dark:focus:ring-light shadow-sm",
  error: "text-error bg-light border hover:bg-light hover:opacity-70 disabled:cursor-not-allowed focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center  items-center dark:bg-transparent dark:border-gray-600 dark:text-error dark:hover:bg-transparent dark:focus:ring-light shadow-sm",
  accent: "text-accent bg-light border hover:bg-light hover:opacity-70 disabled:cursor-not-allowed focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center  items-center dark:bg-transparent dark:border-gray-600 dark:text-accent dark:hover:bg-transparent dark:focus:ring-light shadow-sm",
  warning: "text-warning bg-light border hover:bg-light hover:opacity-70 disabled:cursor-not-allowed focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center  items-center dark:bg-transparent dark:border-gray-600 dark:text-warning dark:hover:bg-transparent dark:focus:ring-light shadow-sm",
